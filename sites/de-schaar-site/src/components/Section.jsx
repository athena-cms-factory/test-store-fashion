                      ...
                      <div className="relative group/category">
                        <div className="flex items-center gap-6 mb-10">
                          <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-lg shrink-0">
                            <img src={group.afbeelding} className="w-full h-full object-cover" data-dock-type="media" data-dock-bind={`diensten_hoofdgroepen.${group.originalIndex}.${afbeelding}`} />
                          </div>
                    ...
                    return (
                      <div key={index} className={itemClass + " w-full max-w-2xl mx-auto"}>
                        <div className="flex justify-between items-end border-b border-dotted border-slate-300 dark:border-white/20 pb-4">
                          ...
                          <span className="font-serif font-bold text-lg text-text ml-4" data-dock-type="text" data-dock-bind={`config.table.toLowerCase().${0}.${priceKey}`}>{item[priceKey]}</span>
                        </div>
                      </div>
                    );
                  }
