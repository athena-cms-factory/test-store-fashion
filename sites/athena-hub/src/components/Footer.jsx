        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-20 mb-20">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-serif font-bold text-white">
              <span data-dock-type="text" data-dock-bind="_site_settings.0.site_name">{naam}</span>
            </h3>
            {settings.tagline && (
            ...
            <ul className="space-y-4">
              ...
              {linkedin && (
                <li className="flex items-center gap-4">
                  ...
                  <a href={linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" data-dock-type="link" data-dock-bind="contact.0.linkedin_url">LinkedIn Profiel</a>
                </li>
              )}
            </ul>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm font-light leading-relaxed">
                <span data-dock-type="text" data-dock-bind="_site_settings.0.footer_text">{settings.footer_text || 'Professionele website geleverd door Athena CMS Factory.'}</span>
              </p>
            </div>
          </div>
